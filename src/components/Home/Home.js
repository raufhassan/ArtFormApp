      ...
      txn.executeSql(
        ...
        function (tx, res) {
          ...
          if (res.rows.length == 0) {
            ...
            txn.executeSql(
              "CREATE TABLE IF NOT EXISTS dependents(dep_id INTEGER PRIMARY KEY AUTOINCREMENT,user_id INT(10), dep_name VARCHAR(20), dep_relation VARCHAR(10), dep_DOB VARCHAR(20), dep_education VARCHAR(10), dep_income INT(15), councelling INT(1), education INT(1))",
              []
            );
          }
        }
